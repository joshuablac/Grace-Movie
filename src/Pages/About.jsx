...
console.log(bookmarkedMovies)
  const functiondata = async () => {
    ...
    try {
      const movieRef = doc(db, "movies10", "10");
  ...
  const movieRecommendation = async () => {
    const moviedot = doc(db, "movies10", "10");
...
<h1 className='md:text-4xl text-2xl pl-15 md:pl-27 md:pl-45 bg-gray-900  text-white w-full h-17 pt-14text-4xl pl-27 md:pl-45 bg-gray-900  text-white w-full h-17 pt-14'>MOVIES</h1>
...
return(
  ...
  <div className="relative w-93   h-98 md:h-98 text-white overflow-hidden group bg-gray-900 p-4 flex flex-col justify-between ">
...
<h1 className="text-2xl text-white  font-semibold leading-tight truncate flex items-left  pl-10">{prop.original_title.slice(0,20)}</h1>
</div>
  </Link>
